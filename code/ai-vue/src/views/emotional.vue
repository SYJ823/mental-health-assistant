<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="createTime" label="生活指标" width="100">
            <template #default="scope">
                <div>
            ...
            <div class="detail-section">
                ...
                <el-descriptions :column="2" border>
                    ...
                    <el-descriptions-item label="风险等级">
                        <el-tag :type="getRiskLevelTagType(aiData.riskLevel)">{{ getRiskLevelText(aiData.riskLevel) || '无' }}</el-tag>
                    </el-descriptions-item>
...
const viewSessionDetail = (row) => {
  ...
  if(row.hasAiEmotionAnalysis) {
    aiData.value = JSON.parse(row.aiEmotionAnalysis); // 解析JSON字符串为对象
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确认删除情绪日志${row.id}吗？`, '确认', {
