    ...
    <div class="home-container">
        <div class="content">
            <div class="text">
                ...
                <p class="description">每个深夜，每个焦虑的时候，我们都在这里，不必独自承受，让心与心的连接温暖您的每一天</p>
...
const robotIconUrl = new URL("@/assets/images/robot-fill.png", import.meta.url).href;
</script>
